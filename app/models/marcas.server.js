...
export async function getArmani(url) {
    const respuesta = await fetch(`${process.env.API_URL}/armanis?filters[url]=${url}&fields=nombre&fields=precio&fields=descripcion&fields=color&fields=stock&fields=genero&fields=imagen&fields=imagen2&fields=tallas&fields=distintivo&fields=url&populate=imagen&populate=imagen2`)
    return await respuesta.json()
}
